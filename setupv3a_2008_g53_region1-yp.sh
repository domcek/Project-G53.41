# Setup file for region 1 2008 observation (legacy identification 2008_yp)
...
export src_name='g53_2008_yp'
export src_reg='(X,Y) IN annulus(18336,38908,1300,4200) && (X,Y) IN pie(18336,38908,310,420) '
...
export src_source_x=20911
export src_source_y=39261
