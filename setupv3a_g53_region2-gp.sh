# Setup file for region 2 (legacy identification _gp)
heainit
sasinit
...
export src_name='g53_gp'
export src_reg='(X,Y) IN annulus(26500,28000,1300,4200) && (X,Y) IN pie(26500,28000,60,150)'
...
export src_source_x=25786
export src_source_y=30574
