# Setup file for region 3 (legacy identification _dp_adj)
...
export src_name='g53_dp_adj'
export src_reg='(X,Y) IN annulus(26500,28000,1300,4200) && (X,Y) IN pie(26500,28000,170,290) '
...
export src_source_x=24813
export src_source_y=26047	
